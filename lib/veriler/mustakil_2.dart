...
class Mustakil2 extends StatefulWidget {
  const Mustakil2({Key? key}) : super(key: key);

  @override
  _Mustakil2State createState() => _Mustakil2State();
}

class _Mustakil2State extends State<Mustakil2> {
  @override
  Widget build(BuildContext context) {
    return CustomScrollView(
      slivers: [
        SliverAppBar(
          centerTitle: true,
          title: Text("Satılık Müstakil Ev",
